...
(function ($) {
    ...
    $.mobiscroll.presets.datehour = function(inst) {
        var orig = $.extend({}, inst.settings), // Make a copy of the original settings
        	...
        	if (s.weekText[currDate.getDay()]=="周一" ||s.weekText[currDate.getDay()]=="周二"||s.weekText[currDate.getDay()]=="周三"||s.weekText[currDate.getDay()]=="周四"||s.weekText[currDate.getDay()]=="周五") {
        		if (currh >= 16) {
        			s.daysCount = 90;
        		}
        	} else if (s.weekText[currDate.getDay()]=="周六" ||s.weekText[currDate.getDay()]=="周日") {
        		if (currh >= 14) {
        			s.daysCount = 90;
        		}
        	}
...
//            },
	    ...
	    // 				nD = new Date(nD);					 
					// 	cH = 12;
					// }
    				/* } else if (s.weekText[nD.getDay()]=="周六" ||s.weekText[nD.getDay()]=="周日") {
    					if(cH >= 0 && cH <8){
    						cH = 10;
    					} else if(cH >=8 && cH < 14){
    						if(cM==0)
